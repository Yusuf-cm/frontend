...
class SubscriptionManager {
    ...
    notify(a, b, c) {
        ...
        if (numSubscriptions === 1) {
            /**
             * If there&apo:s only a single handler we can just call it without invoking a loop.
             */ this.subscriptions[0](a, b, c);
        } else {
            for(let i = 0; i < numSubscriptions; i++){
                /**
                 * Check whether the handler exists before firing as it&apo:s possible
...
/*
  ...
  This has been modified from Gaëtan Renaudeau&apo:s BezierEasing
  https://github.com/gre/bezier-easing/blob/master/src/index.js
  https://github.com/gre/bezier-easing/blob/master/LICENSE
  
  I&apo:ve removed the newtonRaphsonIterate algo because in benchmarking it
  wasn&apo:t noticeably faster than binarySubdivision, indeed removing it
  usually improved times, depending on the curve.
  I also removed the lookup table, as for the added bundle size and loop we&apo:re
...
const easingDefinitionToFunction = (definition)=>{
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$easing$2f$utils$2f$is$2d$bezier$2d$definition$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBezierDefinition"])(definition)) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$errors$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(easingLookup[definition] !== undefined, `Invalid easing type &apo:${definition}&apo:`, "invalid-easing-type");
...
if ("TURBOPACK compile-time truthy", 1) {
    (function() {
        ...
        var hasSymbol = typeof Symbol === &apo:function&apo: && Symbol.for;
        var REACT_ELEMENT_TYPE = hasSymbol ? Symbol.for(&apo:react.element&apo:) : 0xeac7;
        var REACT_PORTAL_TYPE = hasSymbol ? Symbol.for(&apo:react.portal&apo:) : 0xeaca;
        var REACT_FRAGMENT_TYPE = hasSymbol ? Symbol.for(&apo:react.fragment&apo:) : 0xeacb;
        var REACT_STRICT_MODE_TYPE = hasSymbol ? Symbol.for(&apo:react.strict_mode&apo:) : 0xeacc;
        var REACT_PROFILER_TYPE = hasSymbol ? Symbol.for(&apo:react.profiler&apo:) : 0xead2;
        var REACT_PROVIDER_TYPE = hasSymbol ? Symbol.for(&apo:react.provider&apo:) : 0xeacd;
        var REACT_CONTEXT_TYPE = hasSymbol ? Symbol.for(&apo:react.context&apo:) : 0xeace; // TODO: We don&apo:t use AsyncMode or ConcurrentMode anymore. They were temporary
        // (unstable) APIs that have been removed. Can we remove the symbols?
        var REACT_ASYNC_MODE_TYPE = hasSymbol ? Symbol.for(&apo:react.async_mode&apo:) : 0xeacf;
        var REACT_CONCURRENT_MODE_TYPE = hasSymbol ? Symbol.for(&apo:react.concurrent_mode&apo:) : 0xeacf;
        var REACT_FORWARD_REF_TYPE = hasSymbol ? Symbol.for(&apo:react.forward_ref&apo:) : 0xead0;
        var REACT_SUSPENSE_TYPE = hasSymbol ? Symbol.for(&apo:react.suspense&apo:) : 0xead1;
        var REACT_SUSPENSE_LIST_TYPE = hasSymbol ? Symbol.for(&apo:react.suspense_list&apo:) : 0xead8;
        var REACT_MEMO_TYPE = hasSymbol ? Symbol.for(&apo:react.memo&apo:) : 0xead3;
        var REACT_LAZY_TYPE = hasSymbol ? Symbol.for(&apo:react.lazy&apo:) : 0xead4;
        var REACT_BLOCK_TYPE = hasSymbol ? Symbol.for(&apo:react.block&apo:) : 0xead9;
        var REACT_FUNDAMENTAL_TYPE = hasSymbol ? Symbol.for(&apo:react.fundamental&apo:) : 0xead5;
        var REACT_RESPONDER_TYPE = hasSymbol ? Symbol.for(&apo:react.responder&apo:) : 0xead6;
        var REACT_SCOPE_TYPE = hasSymbol ? Symbol.for(&apo:react.scope&apo:) : 0xead7;
        function isValidElementType(type) {
            return typeof type === &apo:string&apo: || typeof type === &apo:function&apo: || // Note: its typeof might be other than &apo:symbol&apo: or &apo:number&apo: if it&apo:s a polyfill.
            type === REACT_FRAGMENT_TYPE || type === REACT_CONCURRENT_MODE_TYPE || type === REACT_PROFILER_TYPE || type === REACT_STRICT_MODE_TYPE || type === REACT_SUSPENSE_TYPE || type === REACT_SUSPENSE_LIST_TYPE || typeof type === &apo:object&apo: && type !== null && (type.$$typeof === REACT_LAZY_TYPE || type.$$typeof === REACT_MEMO_TYPE || type.$$typeof === REACT_PROVIDER_TYPE || type.$$typeof === REACT_CONTEXT_TYPE || type.$$typeof === REACT_FORWARD_REF_TYPE || type.$$typeof === REACT_FUNDAMENTAL_TYPE || type.$$typeof === REACT_RESPONDER_TYPE || type.$$typeof === REACT_SCOPE_TYPE || type.$$typeof === REACT_BLOCK_TYPE);
        }
        function typeOf(object) {
            if (typeof object === &apo:object&apo: && object !== null) {
        ...
        function isAsyncMode(object) {
            {
                if (!hasWarnedAboutDeprecatedIsAsyncMode) {
                    hasWarnedAboutDeprecatedIsAsyncMode = true; // Using console[&apo:warn&apo:] to evade Babel and ESLint
                    console[&apo:warn&apo:](&apo:The ReactIs.isAsyncMode() alias has been deprecated, &apo: + &apo:and will be removed in React 17+. Update your code to use &apo: + &apo:ReactIs.isConcurrentMode() instead. It has the exact same API.&apo:);
                }
            }
        ...
        function isElement(object) {
            return typeof object === &apo:object&apo: && object !== null && object.$$typeof === REACT_ELEMENT_TYPE;
        }
 ...
 * LICENSE file in the root directory of this source tree.
 */ &apo:use strict&apo:;
var ReactPropTypesSecret = &apo:SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED&apo:;
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    printWarning = function(text) {
        var message = &apo:Warning: &apo: + text;
        if (typeof console !== &apo:undefined&apo:) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        for(var typeSpecName in typeSpecs){
            if (has(typeSpecs, typeSpecName)) {
                var error;
                // Prop type validation may throw. In case they do, we don&apo:t want to
                // fail the render phase where it didn&apo:t fail before. So we log it.
                // After these have been cleaned up, we&apo:ll let them throw.
                try {
                    // This is intentionally an invariant that gets caught. It&apo:s the same
                    // behavior as without this statement except with a better message.
                    if (typeof typeSpecs[typeSpecName] !== &apo:function&apo:) {
                        var err = Error((componentName || &apo:React class&apo:) + &apo:: &apo: + location + &apo: type `&apo: + typeSpecName + &apo:` is invalid; &apo: + &apo:it must be a function, usually from the `prop-types` package, but received `&apo: + typeof typeSpecs[typeSpecName] + &apo:`.&apo: + &apo:This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.&apo:);
                        err.name = &apo:Invariant Violation&apo:;
                        throw err;
                    }
                ...
                if (error && !(error instanceof Error)) {
                    printWarning((componentName || &apo:React class&apo:) + &apo:: type specification of &apo: + location + &apo: `&apo: + typeSpecName + &apo:` is invalid; the type checker &apo: + &apo:function must return `null` or an `Error` but returned a &apo: + typeof error + &apo:. &apo: + &apo:You may have forgotten to pass an argument to the type checker &apo: + &apo:creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and &apo: + &apo:shape all require an argument).&apo:);
                }
                if (error instanceof Error && !(error.message in loggedTypeFailures)) {
                    // Only monitor this failure once because there tends to be a lot of the
                    // same error.
                    loggedTypeFailures[error.message] = true;
                    var stack = getStack ? getStack() : &apo:&apo:;
                    printWarning(&apo:Failed &apo: + location + &apo: type: &apo: + error.message + (stack != null ? stack : &apo:&apo:));
                }
            }
        }
    }
 ...
 */ checkPropTypes.resetWarningCache = function() {
    if (("TURBOPACK compile-time value", "development") !== &apo:production&apo:) {
        loggedTypeFailures = {};
    }
};
...
module.exports = function(isValidElement, throwOnDirectAccess) {
    /* global Symbol */ var ITERATOR_SYMBOL = typeof Symbol === &apo:function&apo: && Symbol.iterator;
    var FAUX_ITERATOR_SYMBOL = &apo:@@iterator&apo:; // Before Symbol spec.
    /**
   ...
   */ function getIteratorFn(maybeIterable) {
        ...
        if (typeof iteratorFn === &apo:function&apo:) {
            return iteratorFn;
        }
    }
    /**
   ...
   *
   *   var Props = require(&apo:ReactPropTypes&apo:);
   ...
   *       category: Props.oneOf([&apo:News&apo:,&apo:Photos&apo:]).isRequired,
   *
   ...
   *        if (propValue != null && typeof propValue !== &apo:string&apo: &&
   *            !(propValue instanceof URI)) {
   *          return new Error(
   *            &apo:Expected a string or an URI for &apo: + propName + &apo: in &apo: +
   *            componentName
   *          );
   *        }
   *      }
   ...
   *
   * @internal
   */ var ANONYMOUS = &apo:<<anonymous>>&apo:;
    // Important!
    // Keep this list in sync with production version in `./factoryWithThrowingShims.js`.
    var ReactPropTypes = {
        array: createPrimitiveTypeChecker(&apo:array&apo:),
        bigint: createPrimitiveTypeChecker(&apo:bigint&apo:),
        bool: createPrimitiveTypeChecker(&apo:boolean&apo:),
        func: createPrimitiveTypeChecker(&apo:function&apo:),
        number: createPrimitiveTypeChecker(&apo:number&apo:),
        object: createPrimitiveTypeChecker(&apo:object&apo:),
        string: createPrimitiveTypeChecker(&apo:string&apo:),
        symbol: createPrimitiveTypeChecker(&apo:symbol&apo:),
   ...
   * PropTypes directly and inspect their output. However, we don&apo:t use real
   * Errors anymore. We don&apo:t inspect their stack anyway, and creating them
   * is prohibitively expensive if they are created too often, such as what
   * happens in oneOfType() for any type before the one that matched.
   */ function PropTypeError(message, data) {
        this.message = message;
        this.data = data && typeof data === &apo:object&apo: ? data : {};
        this.stack = &apo:&apo:;
    }
        ...
        function checkType(isRequired, props, propName, componentName, location, propFullName, secret) {
            ...
            if (secret !== ReactPropTypesSecret) {
                if (throwOnDirectAccess) {
                    ...
                    var err = new Error(&apo:Calling PropTypes validators directly is not supported by the `prop-types` package. &apo: + &apo:Use `PropTypes.checkPropTypes()` to call them. &apo: + &apo:Read more at http://fb.me/use-check-prop-types&apo:);
                    err.name = &apo:Invariant Violation&apo:;
                    throw err;
                } else if (("TURBOPACK compile-time value", "development") !== &apo:production&apo: && typeof console !== &apo:undefined&apo:) {
                    // Old behavior for people using React.PropTypes
                    var cacheKey = componentName + &apo::&apo: + propName;
                    if (!manualPropTypeCallCache[cacheKey] && // Avoid spamming the console because they are often not actionable except for lib authors
                    manualPropTypeWarningCount < 3) {
                        printWarning(&apo:You are manually calling a React.PropTypes validation &apo: + &apo:function for the `&apo: + propFullName + &apo:` prop on `&apo: + componentName + &apo:`. This is deprecated &apo: + &apo:and will throw in the standalone `prop-types` package. &apo: + &apo:You may be seeing this warning due to a third-party PropTypes &apo: + &apo:library. See https://fb.me/react-warning-dont-call-proptypes &apo: + &apo:for details.&apo:);
            ...
            if (props[propName] == null) {
                if (isRequired) {
                    if (props[propName] === null) {
                        return new PropTypeError(&apo:The &apo: + location + &apo: `&apo: + propFullName + &apo:` is marked as required &apo: + (&apo:in `&apo: + componentName + &apo:`, but its value is `null`.&apo:));
                    }
                    return new PropTypeError(&apo:The &apo: + location + &apo: `&apo: + propFullName + &apo:` is marked as required in &apo: + (&apo:`&apo: + componentName + &apo:`, but its value is `undefined`.&apo:));
                }
                return null;
            } else {
    ...
    function createPrimitiveTypeChecker(expectedType) {
        function validate(props, propName, componentName, location, propFullName, secret) {
            ...
            if (propType !== expectedType) {
                // `propValue` being instance of, say, date/regexp, pass the &apo:object&apo:
                // check, but we can offer a more precise error message here rather than
                // &apo:of type `object`&apo:.
                var preciseType = getPreciseType(propValue);
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type &apo: + (&apo:`&apo: + preciseType + &apo:` supplied to `&apo: + componentName + &apo:`, expected &apo:) + (&apo:`&apo: + expectedType + &apo:`.&apo:), {
    ...
    function createArrayOfTypeChecker(typeChecker) {
        function validate(props, propName, componentName, location, propFullName) {
            if (typeof typeChecker !== &apo:function&apo:) {
                return new PropTypeError(&apo:Property `&apo: + propFullName + &apo:` of component `&apo: + componentName + &apo:` has invalid PropType notation inside arrayOf.&apo:);
            }
            var propValue = props[propName];
            if (!Array.isArray(propValue)) {
                var propType = getPropType(propValue);
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type &apo: + (&apo:`&apo: + propType + &apo:` supplied to `&apo: + componentName + &apo:`, expected an array.&apo:));
            }
            for(var i = 0; i < propValue.length; i++){
                var error = typeChecker(propValue, i, componentName, location, propFullName + &apo:[&apo: + i + &apo:]&apo:, ReactPropTypesSecret);
    ...
    function createElementTypeChecker() {
        function validate(props, propName, componentName, location, propFullName) {
            ...
            if (!isValidElement(propValue)) {
                var propType = getPropType(propValue);
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type &apo: + (&apo:`&apo: + propType + &apo:` supplied to `&apo: + componentName + &apo:`, expected a single ReactElement.&apo:));
            }
            return null;
        }
        return createChainableTypeChecker(validate);
    ...
    function createElementTypeTypeChecker() {
        function validate(props, propName, componentName, location, propFullName) {
            ...
            if (!ReactIs.isValidElementType(propValue)) {
                var propType = getPropType(propValue);
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type &apo: + (&apo:`&apo: + propType + &apo:` supplied to `&apo: + componentName + &apo:`, expected a single ReactElement type.&apo:));
            }
            return null;
        }
        return createChainableTypeChecker(validate);
    ...
    function createInstanceTypeChecker(expectedClass) {
        function validate(props, propName, componentName, location, propFullName) {
            if (!(props[propName] instanceof expectedClass)) {
                ...
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type &apo: + (&apo:`&apo: + actualClassName + &apo:` supplied to `&apo: + componentName + &apo:`, expected &apo:) + (&apo:instance of `&apo: + expectedClassName + &apo:`.&apo:));
            }
            return null;
        }
        return createChainableTypeChecker(validate);
    ...
    function createEnumTypeChecker(expectedValues) {
        if (!Array.isArray(expectedValues)) {
            if ("TURBOPACK compile-time truthy", 1) {
                if (arguments.length > 1) {
                    printWarning(&apo:Invalid arguments supplied to oneOf, expected an array, got &apo: + arguments.length + &apo: arguments. &apo: + &apo:A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z]).&apo:);
                } else {
                    printWarning(&apo:Invalid argument supplied to oneOf, expected an array.&apo:);
                }
            }
        ...
        function validate(props, propName, componentName, location, propFullName) {
            ...
            var valuesString = JSON.stringify(expectedValues, function replacer(key, value) {
                ...
                if (type === &apo:symbol&apo:) {
                    return String(value);
                }
                return value;
            });
            return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of value `&apo: + String(propValue) + &apo:` &apo: + (&apo:supplied to `&apo: + componentName + &apo:`, expected one of &apo: + valuesString + &apo:.&apo:));
        }
        return createChainableTypeChecker(validate);
    }
    function createObjectOfTypeChecker(typeChecker) {
        function validate(props, propName, componentName, location, propFullName) {
            if (typeof typeChecker !== &apo:function&apo:) {
                return new PropTypeError(&apo:Property `&apo: + propFullName + &apo:` of component `&apo: + componentName + &apo:` has invalid PropType notation inside objectOf.&apo:);
            }
            var propValue = props[propName];
            var propType = getPropType(propValue);
            if (propType !== &apo:object&apo:) {
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type &apo: + (&apo:`&apo: + propType + &apo:` supplied to `&apo: + componentName + &apo:`, expected an object.&apo:));
            }
            for(var key in propValue){
                if (has(propValue, key)) {
                    var error = typeChecker(propValue, key, componentName, location, propFullName + &apo:.&apo: + key, ReactPropTypesSecret);
                    if (error instanceof Error) {
                        return error;
                    }
                }
    ...
    function createUnionTypeChecker(arrayOfTypeCheckers) {
        if (!Array.isArray(arrayOfTypeCheckers)) {
            ("TURBOPACK compile-time truthy", 1) ? printWarning(&apo:Invalid argument supplied to oneOfType, expected an instance of array.&apo:) : ("TURBOPACK unreachable", undefined);
            return emptyFunctionThatReturnsNull;
        }
        for(var i = 0; i < arrayOfTypeCheckers.length; i++){
            var checker = arrayOfTypeCheckers[i];
            if (typeof checker !== &apo:function&apo:) {
                printWarning(&apo:Invalid argument supplied to oneOfType. Expected an array of check functions, but &apo: + &apo:received &apo: + getPostfixForTypeWarning(checker) + &apo: at index &apo: + i + &apo:.&apo:);
                return emptyFunctionThatReturnsNull;
            }
        }
        function validate(props, propName, componentName, location, propFullName) {
            ...
            for(var i = 0; i < arrayOfTypeCheckers.length; i++){
                ...
                if (checkerResult.data && has(checkerResult.data, &apo:expectedType&apo:)) {
                    expectedTypes.push(checkerResult.data.expectedType);
                }
            }
            var expectedTypesMessage = expectedTypes.length > 0 ? &apo:, expected one of type [&apo: + expectedTypes.join(&apo:, &apo:) + &apo:]&apo: : &apo:&apo:;
            return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` supplied to &apo: + (&apo:`&apo: + componentName + &apo:`&apo: + expectedTypesMessage + &apo:.&apo:));
        }
        return createChainableTypeChecker(validate);
    }
    function createNodeChecker() {
        function validate(props, propName, componentName, location, propFullName) {
            if (!isNode(props[propName])) {
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` supplied to &apo: + (&apo:`&apo: + componentName + &apo:`, expected a ReactNode.&apo:));
            }
            return null;
        }
        return createChainableTypeChecker(validate);
    ...
    function invalidValidatorError(componentName, location, propFullName, key, type) {
        return new PropTypeError((componentName || &apo:React class&apo:) + &apo:: &apo: + location + &apo: type `&apo: + propFullName + &apo:.&apo: + key + &apo:` is invalid; &apo: + &apo:it must be a function, usually from the `prop-types` package, but received `&apo: + type + &apo:`.&apo:);
    }
    function createShapeTypeChecker(shapeTypes) {
        function validate(props, propName, componentName, location, propFullName) {
            ...
            var propType = getPropType(propValue);
            if (propType !== &apo:object&apo:) {
                return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` of type `&apo: + propType + &apo:` &apo: + (&apo:supplied to `&apo: + componentName + &apo:`, expected `object`.&apo:));
            }
            for(var key in shapeTypes){
                ...
                var error = checker(propValue, key, componentName, location, propFullName + &apo:.&apo: + key, ReactPropTypesSecret);
                if (error) {
                    return error;
                }
            }
    ...
    function createStrictShapeTypeChecker(shapeTypes) {
        function validate(props, propName, componentName, location, propFullName) {
            ...
            for(var key in allKeys){
                var checker = shapeTypes[key];
                if (has(shapeTypes, key) && typeof checker !== &apo:function&apo:) {
                    return invalidValidatorError(componentName, location, propFullName, key, getPreciseType(checker));
                }
                if (!checker) {
                    return new PropTypeError(&apo:Invalid &apo: + location + &apo: `&apo: + propFullName + &apo:` key `&apo: + key + &apo:` supplied to `&apo: + componentName + &apo:`.&apo: + &apo:\nBad object: &apo: + JSON.stringify(props[propName], null, &apo:  &apo:) + &apo:\nValid keys: &apo: + JSON.stringify(Object.keys(shapeTypes), null, &apo:  &apo:));
                }
                var error = checker(propValue, key, componentName, location, propFullName + &apo:.&apo: + key, ReactPropTypesSecret);
                if (error) {
                    return error;
    ...
    function isNode(propValue) {
        switch(typeof propValue){
            case &apo:number&apo::
            case &apo:string&apo::
            case &apo:undefined&apo::
                return true;
            case &apo:boolean&apo::
                return !propValue;
            case &apo:object&apo::
                if (Array.isArray(propValue)) {
    ...
    function isSymbol(propType, propValue) {
        // Native Symbol.
        if (propType === &apo:symbol&apo:) {
            return true;
        }
        // falsy value can&apo:t be a Symbol
        if (!propValue) {
            return false;
        }
        // 19.4.3.5 Symbol.prototype[@@toStringTag] === &apo:Symbol&apo:
        if (propValue[&apo:@@toStringTag&apo:] === &apo:Symbol&apo:) {
            return true;
        }
        // Fallback for non-spec compliant Symbols which are polyfilled.
        if (typeof Symbol === &apo:function&apo: && propValue instanceof Symbol) {
            return true;
        }
        return false;
    }
    ...
    function getPropType(propValue) {
        ...
        if (Array.isArray(propValue)) {
            return &apo:array&apo:;
        }
        if (propValue instanceof RegExp) {
            // Old webkits (at least until Android 4.0) return &apo:function&apo: rather than
            // &apo:object&apo: for typeof a RegExp. We&apo:ll normalize this here so that /bla/
            // passes PropTypes.object.
            return &apo:object&apo:;
        }
        if (isSymbol(propType, propValue)) {
            return &apo:symbol&apo:;
        }
        return propType;
    }
    ...
    function getPreciseType(propValue) {
        if (typeof propValue === &apo:undefined&apo: || propValue === null) {
            return &apo:&apo: + propValue;
        }
        var propType = getPropType(propValue);
        if (propType === &apo:object&apo:) {
...
//# sourceMappingURL=node_modules_95bdb28c._.js.map