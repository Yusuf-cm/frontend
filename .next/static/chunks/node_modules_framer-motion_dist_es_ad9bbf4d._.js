 ...
 * it&apo:s easier to consider each axis individually. This function returns a bounding box
 ...
 */ function applyTreeDeltas(box, treeScale, treePath, isSharedTransition = false) {
    ...
    for(let i = 0; i < treeLength; i++){
        ...
        if (delta) {
            // Incoporate each ancestor&apo:s scale into a culmulative treeScale for this component
            treeScale.x *= delta.x.scale;
            treeScale.y *= delta.y.scale;
            // Apply each ancestor&apo:s calculated delta into this component&apo:s recorded layout box
    ...
    /**
     * Snap tree scale back to 1 if it&apo:s within a non-perceivable threshold.
...
function updateMotionValuesFromProps(element, next, prev) {
    for(const key in next){
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$value$2f$utils$2f$is$2d$motion$2d$value$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMotionValue"])(nextValue)) {
             ...
             * to our visual element&apo:s motion value map.
            ...
            /**
             * If we&apo:re swapping from a motion value to a static value,
             ...
             * or create one if it doesn&apo:t exist. We only want to do this if we&apo:re
...
function resolveVariantFromProps(props, definition, custom, visualElement) {
    ...
    /**
     * At this point we&apo:ve resolved both functions and variant labels,
 ...
 */ class VisualElement {
     ...
     *
     * This isn&apo:t an abstract method as it needs calling in the constructor, but it is
     * intended to be one.
    ...
    constructor({ parent, props, presenceContext, reducedMotionConfig, blockInitialAnimation, visualState }, options = {}){
         ...
         */ this.current = null;
        /**
         * A set containing references to this VisualElement&apo:s children.
         ...
         * aren&apo:t yet bound to the element, as this would technically be impure.
         * However, we iterate through the motion values and set them to the
         * initial values for this component.
         *
         * TODO: This is impure and we should look at changing this to run on mount.
         * Doing so will break some tests but this isn&apo:t necessarily a breaking change,
    ...
    sortNodePosition(other) {
        /**
         * If these nodes aren&apo:t even of the same type we can&apo:t compare their depth.
    ...
    /**
     * If we&apo:re trying to animate to a previously unencountered value,
     ...
     */ getBaseTarget(key) {
        ...
        /**
         * If the value was initially defined on initial, but it doesn&apo:t any more,
...
class DOMVisualElement extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$VisualElement$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VisualElement"] {
    ...
    sortInstanceNodePosition(a, b) {
         ...
         * we&apo:re returning true if 2 in that bitmask is set to true. 2 is set
 ...
 */ function buildTransform(latestValues, transform, transformTemplate) {
    // The transform string we&apo:re going to build into.
    let transformString = "";
...
function buildHTMLStyles(state, latestValues, transformTemplate) {
    ...
    if (!latestValues.transform) {
        if (hasTransform || transformTemplate) {
            ...
            /**
             * If we have previously created a transform but currently don&apo:t have any,
...
/**
 * Build SVG path properties. Uses the path&apo:s measured length to convert
...
...latest }, isSVGTag, transformTemplate, styleProp) {
    ...
    if (style.transform) {
        /**
         * SVG&apo:s element transform-origin uses its own median as a reference.
...
function isSVGComponent(Component) {
    if (/**
     * If it&apo:s not a string, it&apo:s a custom React component. Currently we only support
     ...
     * If it&apo:s in our list of lowercase SVG tags, it&apo:s an SVG component
     */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$svg$2f$lowercase$2d$elements$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lowercaseSVGElements"].indexOf(Component) > -1 || /**
         * If it contains a capital letter, it&apo:s an SVG component
...
function useHTMLProps(props, visualState) {
    // The `any` isn&apo:t ideal but it is the type of createElement props argument
    const htmlProps = {};
 ...
 *
 * @privateRemarks
 * This doesn&apo:t throw if a `MotionProp` name is missing - it should.
 */ __turbopack_context__.s({
 ...
 * as it&apo:s seen as an arbitrary component rather than a DOM node. Motion only allows arbitrary props
 * passed through the `custom` prop so it doesn&apo:t *need* the payload or computational overhead of
 * `@emotion/is-prop-valid`, however to fix this problem we need to use it.
 *
 * By making it an optionalDependency we can offer this functionality only in the situations where it&apo:s
 * actually required.
 */ try {
    /**
     * We attempt to import this package but require won&apo:t be defined in esm environments, in that case
     * isPropValid will have to be provided via `MotionContext`. In a 6.0.0 this should probably be removed
     * in favour of explicit injection.
     */ loadExternalIsValidProp((()=>{
        const e = new Error("Cannot find module &apo:@emotion/is-prop-valid&apo:");
        e.code = &apo:MODULE_NOT_FOUND&apo:;
        throw e;
    })().default);
} catch  {
// We don&apo:t need to actually do anything here - the fallback is the existing `isPropValid`.
}
function filterProps(props, isDom, forwardMotionProps) {
    const filteredProps = {};
    for(const key in props){
        /**
         * values is considered a valid prop by Emotion, so if it&apo:s present
 ...
 *
 * Even if `useMemo` is provided an empty array as its final argument, it doesn&apo:t offer
 * a guarantee that it won&apo:t re-run for performance reasons later on. By using `useConstant`
 * you can ensure that initialisers don&apo:t execute twice or more.
 ...
 */ function useMotionRef(visualState, visualElement, externalRef) {
     ...
     * Only pass a new ref callback to React if we&apo:ve received a visual element
     * factory. Otherwise we&apo:ll be mounting/remounting every time externalRef
...
function useVisualElement(Component, visualState, props, createVisualElement, ProjectionNodeConstructor) {
    ...
    /**
     * If we haven&apo:t preloaded a renderer, check to see if we have one lazy-loaded
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$utils$2f$use$2d$isomorphic$2d$effect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIsomorphicLayoutEffect"])({
         ...
         * it needs to happen synchronously to ensure there&apo:s no flash of
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useVisualElement.useEffect": ()=>{
            ...
            /**
         * Now we&apo:ve finished triggering animations for this element we
...
function createProjectionNode(visualElement, props, ProjectionNodeConstructor, initialPromotionConfig) {
    ...
    visualElement.projection.setOptions({
        ...
        visualElement,
        /**
         * TODO: Update options in an effect. This could be tricky as it&apo:ll be too late
         * to update by the time layout animations run.
         * We also need to fix this safeToRemove by linking it up to the one returned by usePresence,
         * ensuring it gets called if there&apo:s no potential layout animations.
         *
...
function useStrictMode(configAndProps, preloadedFeatures) {
    ...
    /**
     * If we&apo:re in development mode, check to make sure we&apo:re not rendering a motion component
...
function createMotionProxy(preloadedFeatures, createVisualElement) {
    ...
    return new Proxy(deprecatedFactoryFunction, {
         ...
         */ get: (_target, key)=>{
            ...
            /**
             * If this element doesn&apo:t exist in the component cache, create it and cache.
...
;
/**
 * Set VisualElement&apo:s MotionValue, creating a new MotionValue for it if
 * it doesn&apo:t exist.
...
function addValueToWillChange(visualElement, key) {
     ...
     * in which case we can&apo:t add the value to it.
...
const animateMotionValue = (name, value, target, transition = {}, element, isHandoff)=>(onComplete)=>{
     ...
     * transitions. In the future it&apo:d be nicer to blend these transitions. But for now
     * delay actually does inherit from the root transition if not value-specific.
     */ const delay = valueTransition.delay || transition.delay || 0;
        /**
     * Elapsed isn&apo:t a public transition option but can be passed through from
     ...
     */ let { elapsed = 0 } = transition;
        ...
        /**
     * If there&apo:s no transition defined for this value, we can generate
     ...
     * then we don&apo:t want to allow flattening the animation.
...
function animateTarget(visualElement, targetAndTransition, { delay = 0, transitionOverride, type } = {}) {
    ...
    for(const key in target){
         ...
         * to see if we&apo:re handling off from an existing animation.
         */ let isHandoff = false;
...
function createAnimationState(visualElement) {
     ...
     */ function animateChanges(changedActiveType) {
        ...
        /**
         * A list of animations that we&apo:ll build into as we iterate through the animation
         ...
         * detect which values it&apo:s handling and whether or not they&apo:ve changed (and therefore
         ...
         */ for(let i = 0; i < numAnimationTypes; i++){
            ...
            if (// If it isn&apo:t active and hasn&apo:t *just* been set as inactive
            !typeState.isActive && activeDelta === null || !prop && !typeState.prevProp || // Or if the prop doesn&apo:t define an animation
             ...
             * coerce everything to an array if it isn&apo:t one already
             */ const definitionList = Array.isArray(prop) ? prop : [
                prop
            ];
            /**
             * Build an object of all the resolved values. We&apo:ll use this in the subsequent
             ...
             * 4. If it hasn&apo:t been removed in a higher priority but hasn&apo:t changed, and
             *    needs adding to the type&apo:s protectedKeys list.
            ...
            for(const key in allKeys){
                ...
                // If we&apo:ve already handled this we can just skip ahead
                ...
                if (valueHasChanged) {
                    if (next !== undefined && next !== null) {
                        // If next is defined and doesn&apo:t equal prev, it needs animating
                        markToAnimate(key);
                    } else {
                        // If it&apo:s undefined, it&apo:s been removed.
                        removedKeys.add(key);
                    }
                } else if (next !== undefined && removedKeys.has(key)) {
                    /**
                     * If next hasn&apo:t changed and it isn&apo:t undefined, we want to check if it&apo:s
                     * been removed by a higher priority
                     */ markToAnimate(key);
                } else {
                    /**
                     * If it hasn&apo:t changed, we add it to the list of protected values
                     * to ensure it doesn&apo:t get animated.
             ...
             * unless the inherited variants haven&apo:t changed on this render.
            ...
            if (shouldAnimateType && needsAnimating) {
                animations.push(...definitionList.map((animation)=>{
                    ...
                    /**
                     * If we&apo:re performing the initial animation, but we&apo:re not
                     * rendering at the same time as the variant-controlling parent,
                     * we want to use the parent&apo:s transition to calculate the stagger.
        ...
        /**
         * If there are some removed value that haven&apo:t been dealt with,
         ...
         */ if (removedKeys.size) {
             ...
             * allow the animation function to use the visual element&apo:s default.
     ...
     */ function setActive(type, isActive) {
        // If the active state hasn&apo:t changed, we can safely do nothing here
...
class AnimationFeature extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$motion$2f$features$2f$Feature$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Feature"] {
    ...
    /**
     * Subscribe any provided AnimationControls to the component&apo:s VisualElement
     */ mount() {
 ...
 */ class PanSession {
    constructor(event, handlers, { transformPagePoint, contextWindow = window, dragSnapToOrigin = false, distanceThreshold = 3 } = {}){
        ...
        this.updatePoint = ()=>{
            ...
            // any larger than this we&apo:ll want to reset the pointer history
        ...
        // If we have more than one touch, don&apo:t start detecting this gesture
...
class VisualElementDragControls {
    ...
    start(originEvent, { snapToCursor = false, distanceThreshold } = {}) {
        /**
         * Don&apo:t start dragging if this component is exiting
        ...
        const onStart = (event, info)=>{
            ...
            if (drag && !dragPropagation) {
                ...
                // If we don &apo:t have the lock, don&apo:t start dragging
        ...
        const onMove = (event, info)=>{
            ...
            // If we didn&apo:t successfully receive the gesture lock, early return.
            if (!dragPropagation && !this.openDragLock) return;
            const { offset } = info;
            // Attempt to detect drag direction if directionLock is true
            if (dragDirectionLock && this.currentDirection === null) {
                this.currentDirection = getCurrentDirection(offset);
                // If we&apo:ve successfully set a direction, notify listener
             ...
             * bounding box to ensure the pointer and element don&apo:t fall out of sync.
    ...
    updateAxis(axis, _point, offset) {
        ...
        // If we&apo:re not dragging this axis, do an early return.
    ...
    resolveConstraints() {
        ...
        /**
         * If we&apo:re outputting to external MotionValues, we want to rebase the measured constraints
    ...
    resolveRefConstraints() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$errors$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(constraintsElement !== null, "If `dragConstraints` is set as a React ref, that ref must be passed to another component&apo:s `ref` prop.", "drag-constraints-ref");
        const { projection } = this.visualElement;
        // TODO
        ...
        /**
         * If there&apo:s an onMeasureDragConstraints listener we call it and
    ...
    startAnimation(velocity) {
        ...
        const momentumAnimations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$projection$2f$utils$2f$each$2d$axis$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["eachAxis"])((axis)=>{
            ...
            /**
             * Overdamp the boundary spring if `dragElastic` is disabled. There&apo:s still a frame
            ...
            // If we&apo:re not animating on an externally-provided `MotionValue` we can use the
            // component&apo:s animation controls which will handle interactions with whileHover (etc),
    ...
    addListeners() {
        ...
        /**
         * If the element&apo:s layout changes, calculate the delta and apply that to
         * the drag gesture&apo:s origin point.
...
/**
 * Based on an x/y offset determine the current drag direction. If both axis&apo: offsets are lower
...
class DragGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$motion$2f$features$2f$Feature$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Feature"] {
    ...
    mount() {
        // If we&apo:ve been provided a DragControls for manual control over the drag gesture,
 ...
 * to access information about whether it&apo:s still present in the React tree.
 *
 * ```jsx
 ...
 * `AnimatePresence` won&apo:t really remove it until `safeToRemove` has been called.
 *
 * @public
 */ function usePresence(subscribe = true) {
    ...
    // It&apo:s safe to call the following hooks conditionally (after an early return) because the context will always
 ...
 *
 *   useEffect(() => {
 *     !isPresent && console.log("I&apo:ve been removed!")
 *   }, [isPresent])
 *
 *   return <div />
 * }
...
{
/**
 * This should only ever be modified on the client otherwise it&apo:ll
 ...
 * a paint each time. If we animate between the two in percentage we&apo:ll avoid a paint.
 */ const correctBorderRadius = {
    correct: (latest, node)=>{
        if (!node.target) return latest;
        /**
         * If latest is a string, if it&apo:s a percentage we can return immediately as it&apo:s
         * going to be stretched appropriately. Otherwise, if it&apo:s a pixel, convert it to a number.
        ...
        /**
         * If latest is a number, it&apo:s a pixel value. We use the current viewportBox to calculate that
...
const correctBoxShadow = {
    correct: (latest, { treeScale, projectionDelta })=>{
        ...
        // TODO: Doesn&apo:t support multiple shadows
        ...
        /**
         * Ideally we&apo:d correct x and y scales individually, but because blur and
...
;
/**
 * Track whether we&apo:ve taken any snapshots yet. If not,
...
class MeasureLayoutWithContext extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"] {
    ...
    getSnapshotBeforeUpdate(prevProps) {
         ...
         * promote a previous element. There&apo:s no guarantee its presence data
        ...
        if (prevProps.isPresent !== isPresent) {
            if (isPresent) {
                ...
                /**
                 * If there&apo:s another stack member taking over from this one,
                 * it&apo:s in charge of the exit animation and therefore should
...
// /**
//  * We only want to mix the background color if there&apo:s a follow element
//  * that we&apo:re not crossfading opacity between. For instance with switch
...
// ) {
//     /**
//      * This isn&apo:t ideal performance-wise as mixColor is creating a new function every frame.
...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
    return class ProjectionNode {
        constructor(latestValues = {}, parent = defaultParent?.()){
            ...
            /**
             * A Set containing all this component&apo:s children. This is used to iterate
            ...
            /**
             * Flag to true if we think this layout has been changed. We can&apo:t always know this,
         ...
         */ mount(instance) {
            ...
            if (this.options.animate !== false && visualElement && (layoutId || layout)) {
                this.addEventListener("didUpdate", ({ delta, hasLayoutChanged, hasRelativeLayoutChanged, layout: newLayout })=>{
                    ...
                    /**
                     * If the layout hasn&apo:t seemed to have changed, it might be that the
                    ...
                    if (this.options.layoutRoot || this.resumeFrom || hasOnlyRelativeTargetChanged || hasLayoutChanged && (hasTargetChanged || !this.currentAnimation)) {
                        ...
                        /**
                         * If the layout hasn&apo:t changed and we have an animation that hasn&apo:t started yet,
        ...
        willUpdate(shouldNotifyListeners = true) {
            ...
            /**
             * If we&apo:re running optimised appear animations then these must be
             ...
             * This has to happen here though, as we don&apo:t yet know which nodes will need
        ...
        updateLayout() {
            ...
            /**
             * When a node is mounted, it simply resumes from the prevLead&apo:s
        ...
        forceRelativeParentToResolveTarget() {
            ...
            /**
             * If the parent target isn&apo:t up-to-date, force it to update.
        ...
        resolveTargetDelta(forceRecalculation = false) {
            ...
            /**
             * We don&apo:t use transform for this step of processing so we don&apo:t
             * need to check whether any nodes have changed transform.
             */ const canSkip = !(forceRecalculation || isShared && this.isSharedProjectionDirty || this.isProjectionDirty || this.parent?.isProjectionDirty || this.attemptToResolveRelativeTarget || this.root.updateBlockedByResize);
            if (canSkip) return;
            const { layout, layoutId } = this.options;
            /**
             * If we have no layout, we can&apo:t perform projection, so early return
            ...
            /**
             * If we don&apo:t have a targetDelta but do have a layout, we can attempt to resolve
            ...
            /**
             * If we have no relative target or no target delta our target isn&apo:t valid
             * for this frame.
            ...
            /**
             * If we&apo:ve got a relative box for this component, resolve it into a target relative to the parent.
            ...
            /**
                 * If we&apo:ve only got a targetDelta, resolve it into a target
            ...
            /**
             * If we&apo:ve been told to attempt to resolve a relative target, do so.
        ...
        calcProjection() {
             ...
             * is dirty then we can&apo:t skip.
             */ if (this.isProjectionDirty || this.parent?.isProjectionDirty) {
                canSkip = false;
            }
            /**
             * If this is a shared layout animation and this node&apo:s shared projection is dirty then
             * we can&apo:t skip.
            ...
            const { layout, layoutId } = this.options;
            /**
             * If this section of the tree isn&apo:t animating we can
            ...
            if (!this.layout || !(layout || layoutId)) return;
            /**
             * Reset the corrected box with the latest values from box, as we&apo:re then going
            ...
            /**
             * If this layer needs to perform scale correction but doesn&apo:t have a target,
            ...
            if (!target) {
                /**
                 * If we don&apo:t have a target to project into, but we were previously
             ...
             * and we wouldn&apo:t have to keep and calc both deltas, OR we could support a user setting
        ...
        applyTransformsToTarget() {
            ...
            /**
             * If we&apo:re only animating position, and this element isn&apo:t the lead element,
        ...
        resetSkewAndRotation() {
            const { visualElement } = this.options;
            if (!visualElement) return;
            // If there&apo:s no detected skew or rotation values, we can early return without a forced render.
            let hasDistortingTransform = false;
            /**
             * An unrolled check for rotation values. Most elements don&apo:t have any rotation and
             * skipping the nested loop and new object creation is 50% faster.
             */ const { latestValues } = visualElement;
            if (latestValues.z || latestValues.rotate || latestValues.rotateX || latestValues.rotateY || latestValues.rotateZ || latestValues.skewX || latestValues.skewY) {
                hasDistortingTransform = true;
            }
            // If there&apo:s no distorting values, we don&apo:t need to do any more.
            ...
            // Schedule a render for the next frame. This ensures we won&apo:t visually
        ...
        applyProjectionStyles(targetStyle, styleProp) {
            ...
            if (lead.animationValues) {
                ...
                /**
                 * Or we&apo:re not animating at all, set the lead component to its layout
             ...
             * that if a follow component covers a lead component it doesn&apo:t block
...
function notifyLayoutUpdate(node) {
    ...
    if (node.isLead() && node.layout && snapshot && node.hasListeners("didUpdate")) {
        ...
        // TODO Maybe we want to also resize the layout snapshot so we don&apo:t trigger
...
function propagateDirtyNodes(node) {
    ...
    /**
     * If this node isn&apo:t projecting, propagate isProjectionDirty. It will have
     * no performance impact but it will allow the next child that *is* projecting
     * but *isn&apo:t* dirty to just check its parent to see if *any* ancestor needs
     * correcting.
...
class FocusGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$motion$2f$features$2f$Feature$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Feature"] {
    ...
    onFocus() {
        ...
        /**
         * If this element doesn&apo:t match focus-visible then don&apo:t
...
function initIntersectionObserver({ root, ...options }) {
    ...
    /**
     * If we don&apo:t have an observer lookup map for this root, create one.
    ...
    /**
     * If we don&apo:t have an observer for this combination of root and settings,
     * create one.
...
class InViewFeature extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$motion$2f$features$2f$Feature$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Feature"] {
    ...
    startObserver() {
        ...
        const onIntersectionUpdate = (entry)=>{
            ...
            /**
             * If there&apo:s been no change in the viewport state, early return.
             */ if (this.isInView === isIntersecting) return;
            this.isInView = isIntersecting;
            /**
             * Handle hasEnteredView. If this is only meant to run once, and
             * element isn&apo:t visible, early return. Otherwise set hasEnteredView to true.
...
function PopChild({ children, isPresent, anchorX, root }) {
     ...
     *
     * We can&apo:t apply size via render as the measurement happens
...
const PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, root })=>{
    ...
    /**
     * If there&apo:s no `motion` components to fire exit animations, we want to remove this
 ...
 */ const AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", root })=>{
    ...
    /**
     * Filter any children that aren&apo:t ReactElements. We can only track components
    ...
    if (presentChildren !== diffedChildren) {
        ...
        /**
         * If we&apo:re in "wait" mode, and we have exiting children, we want to
         * only render these until they&apo:ve all exited.
        ...
        /**
         * Early return to ensure once we&apo:ve set state with the latest diffed
         * children, we can immediately re-render.
         */ return null;
    }
    if (("TURBOPACK compile-time value", "development") !== "production" && mode === "wait" && renderedChildren.length > 1) {
        console.warn(`You&apo:re attempting to animate multiple children within AnimatePresence, but its mode is set to "wait". This will lead to odd visual behaviour.`);
    }
    /**
     * If we&apo:ve been provided a forceRender function by the LayoutGroupContext,
